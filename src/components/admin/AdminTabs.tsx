...
import { Folder, FileText, Settings, BookOpen, Calendar, BarChart3, Users, Inbox, Home, Info, UserPlus, Palette } from "lucide-react";
  ...
  return (
    <Tabs value={activeTab} onValueChange={onTabChange} className="w-full">
      <TabsList className="grid w-full grid-cols-12 mb-8">
        ...
        <TabsTrigger value="mitmachen" className="flex items-center gap-2">
          <UserPlus className="h-4 w-4" />
          <span className="hidden sm:inline">Mitmachen</span>
        </TabsTrigger>
