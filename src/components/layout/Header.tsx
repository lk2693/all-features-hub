        ...
        <nav className="container flex h-16 items-center justify-between lg:h-20">
          ...
          <div className="hidden lg:flex lg:items-center lg:gap-0.5">
            {navigation.map((item) => {
              ...
              return (
                <Link
                  key={item.name}
                  to={item.href}
                  className={cn("relative px-4 py-2 text-sm font-medium transition-colors rounded-lg text-popover",
            ...
            <button
              ...
              className={cn("ml-2 flex items-center gap-2 px-3 py-1.5 rounded-lg border text-sm transition-all text-popover",
